...
function WhatsappIcon(props) {
  return (
    <>
    <span className="group-hover:underline text-sm font-medium bg-transparent border-2 border-secondary py-2 px-3 rounded hidden md:inline-block">Join the conversation</span>
      ...
      <div className="relative flex items-center basis-auto justify-end gap-6 xl:gap-8 md:shrink w-full">
        ...
        {siteConfig.socialLinks && Object.entries(siteConfig.socialLinks).map(([key,value]) => {
          ...
          return <a
            ...
            target="_blank"
          >
           <SocialIcon className="h-6 w-6 dark:fill-slate-400 group-hover:fill-slate-500 dark:group-hover:fill-slate-300" />
          </a>
        })}
      </div>
    </header>
